...
#define DDR_BASE_WRITE_ADDRESS    0x40000000 
...
int main(int argc, char *argv[])
{
    ...
    count = fread(DestArray,sizeof(unsigned char), BUFFER_BYTESIZE, image);
    printf("count is %d\n", count);
   ...
   /*======================================================================================
    ...
    /*======================================================================================
    STEP 9 : Copy the Data from Destination Buffer to  DDR Memory location 0x20000000
    ========================================================================================*/
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //Reset CDMA
      ...
      *((volatile unsigned long *) (mapped_dev_base + XAXICDMA_SRCADDR_OFFSET)) = (unsigned long)DDR_BASE_WRITE_ADDRESS;
...
//sleep (1);
      ...
      //    printf("hello \n\r ");
//              printf("RegValue = %ld \n",RegValue);
//              printf("RegValue & MASK = %d \n",(RegValue & XAXICDMA_XR_IRQ_ALL_MASK));
